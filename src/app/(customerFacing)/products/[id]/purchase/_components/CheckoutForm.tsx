...
import { LinkAuthenticationElement, Elements, PaymentElement, useStripe, useElements } from '@stripe/react-stripe-js'
...
function Form({ priceInCents, productId}: { priceInCents: number, productId: string}) {
    ...
    async function handleSubmit(e: FormEvent) {
        ...
        stripe.confirmPayment({ elements, confirmParams: { return_url: `${process.env.NEXT_PUBLIC_SERVER_URL}/stripe/purchase-success`
        }
    }).then(({ error}) => {
